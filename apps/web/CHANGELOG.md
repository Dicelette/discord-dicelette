...
* add edit command ([5417182](https://github.com/Dicelette/discord-dicelette/commit/5417182b54731629f3c574eb6ab889b22201cb46))
...
* add switching locale & fix locale ([4a81dd9](https://github.com/Dicelette/discord-dicelette/commit/4a81dd99131665a6e3177019a22472d38251f815))
...
* **bot:** enhance dice rolling with custom critical values #custom-critical ([de2887d](https://github.com/Dicelette/discord-dicelette/commit/de2887d68718af4d6497e7b63dd8a8bdd3d7ebc7))
...
* **calc:** add "transform" to round, ceil, floor, sqrt or square the result ([bbc9cda](https://github.com/Dicelette/discord-dicelette/commit/bbc9cda9ad3c4d44e39e1dcc466b46a8ea96bd6a))
...
* **custom-critical:** add custom critical in the embeds for user and template ([00f88bc](https://github.com/Dicelette/discord-dicelette/commit/00f88bc1c23ab143577475dd66522f704cd82f80))
...
* **db:** enhance embed parsing logic for user and template data ([11361f8](https://github.com/Dicelette/discord-dicelette/commit/11361f87178f5c3da1c6013f294f8d41f94d5972))
...
* **modals:** implement user statistics registration and validation ([3d6cbba](https://github.com/Dicelette/discord-dicelette/commit/3d6cbbac5d548cad01f9f23ad17d1ce27c80a646))
...
* **reaction:** allow to copy reaction between saved message/interaction + send result to DM if used with 📩 ([c97c7cf](https://github.com/Dicelette/discord-dicelette/commit/c97c7cf7ddcfd06b676ec8c8c7dac24cb868a748))
...
* **roll:** enhance mj_roll command with autocomplete for transformations ([b90f6eb](https://github.com/Dicelette/discord-dicelette/commit/b90f6ebc0cf3987429011469d727b3f301d1fdd6))
...
* adjust message when editing avatar ([504fed0](https://github.com/Dicelette/discord-dicelette/commit/504fed0db5522b7d72217ffcc0d8469e4003fb47))
...
* **bot:** ensure public channel creation for template command #custom-critical ([201b2cb](https://github.com/Dicelette/discord-dicelette/commit/201b2cbfa1ba7f4c2785fac7d3e9c350e662d780))
* **bot:** remove unnecessary await in downloadTutorialImages call ([ac01d07](https://github.com/Dicelette/discord-dicelette/commit/ac01d07133700327bd87e4a64f1416a7429831d1))
...
* broken type ([8c60946](https://github.com/Dicelette/discord-dicelette/commit/8c60946de97289676058db188a362231d93b5e84))
* build error ([4e9cf15](https://github.com/Dicelette/discord-dicelette/commit/4e9cf1570ca54edc218114766ad419921c2badaa))
...
* change one line ([8712a80](https://github.com/Dicelette/discord-dicelette/commit/8712a80932cce41844577c1944c5d0065510d6db))
...
* crash when the command is used in thread ([c7eddcc](https://github.com/Dicelette/discord-dicelette/commit/c7eddcc19d19dd666dab707eedb9dfc0a4d9969e))
...
* **db:** remove redundant comment in get_user.ts ([99a79c6](https://github.com/Dicelette/discord-dicelette/commit/99a79c6563b4dce8f4c30a8727a3b3dea588aa3d))
...
* **display:** prevent runtime error if guidSettings is not disable ([e21e15b](https://github.com/Dicelette/discord-dicelette/commit/e21e15b6fff9481355e9645251483e0af7cc5f48))
...
* forgot translation between things ([52e6f0d](https://github.com/Dicelette/discord-dicelette/commit/52e6f0d8629cef4a4b2ee205389f95fcba172b4a))
...
* in some condition, discord image link can be cdn ([0f56296](https://github.com/Dicelette/discord-dicelette/commit/0f56296df635e5d6c974df86ad165c3146c515fd))
...
* **parse-result:** parseEmbed not exported ([d8c5e90](https://github.com/Dicelette/discord-dicelette/commit/d8c5e90610d26a00b7cc91b4aafb4d233b09313b))
...
* **roll:** reroll instead of getting the first result when sending to log ([98a0a03](https://github.com/Dicelette/discord-dicelette/commit/98a0a03caeeb21de20eaf1891003837866fd0da4))
...
* **roll:** template not found ([1cfdf8f](https://github.com/Dicelette/discord-dicelette/commit/1cfdf8fdbc607f4614447f2b7cc4093edc1df712))
* **roll:** undefined text in command ([648caaf](https://github.com/Dicelette/discord-dicelette/commit/648caaf72e3cabf0e46666508f35c1fda1c7a30e))
...
* should not throw error when template not found ([2667a8e](https://github.com/Dicelette/discord-dicelette/commit/2667a8e2e47f743b98af4a1373808bab2989e011))
...
* **snippets:** should use reply for better handling result ([94cc092](https://github.com/Dicelette/discord-dicelette/commit/94cc092fce50310141113114e2da9acc3cfe1f9d))
...
* **styles:** update confirm colors for better visibility ([3a9f123](https://github.com/Dicelette/discord-dicelette/commit/3a9f12324d065af06bbbc1905fe046da35d164e7))
...
* typo ([ad08682](https://github.com/Dicelette/discord-dicelette/commit/ad08682a63b699d69b219773a54c337a07182d17))
...
* user shouldn't be mandatory ([1187f36](https://github.com/Dicelette/discord-dicelette/commit/1187f36806f3624bbbbd5e7504e8269564bc159b))
