...
import { getSettings } from "../db/enmap.js";
...
router.patch("/:guildId/config", requireAuth, async (req: Request, res: Response) => {
	...
	// Allowed fields to update via the dashboard (excludes user data and templateID)
	...
	// Merge allowed updates into the current config
...
/** GET /api/guilds/:guildId/invite — generate bot invite URL */
