...
/** Rebuilds a roll-result message with its comment replaced by `newComment` (inserting one if there was none),
 * or `undefined` if `content` isn't a roll-result message or `newComment` is empty once sanitized. */
